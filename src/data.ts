...
export const personalInfo = {
  ...
  motto: "생각에 머물던 기획을 소비자의 움직임으로, 인식이 바뀌는 지점을 설계합니다.",
  vision: "아이디어만 던지는 기획자가 아닙니다. 광고 분석 채널을 직접 키우며 대중의 반응을 지표로 목격했고, 콘텐츠를 만들 줄 알기에 기획단계부터 실무 프로세스를 이해하며, GA4로 캠페인의 성과를 추적합니다. 기획, 제작, 데이터의 삼박자를 갖춘 실전형 올라운더 AE 김도현입니다."
};
...
export const projectsData: ProjectData[] = [
  {
    ...
    subtitle: "[굳이]를 뒤집은 한 단어 - 배경",
    challenge: '"굳이 스크린X로 비싸게 영화를 봐야 해?"라는 소비자 사이에 고착된 심리적 인식 장벽.',
    insight: "관객은 영화를 단순한 영사 기술이 아니라, 극 중 몰입을 극대화하는 강렬한 '배경(공간)'으로 느끼고 오래 기억한다.",
    action: "<에이리언: 로물루스> 영화 속 폐쇄 우주기지 배경을 ScreenX의 넓은 3면 포맷과 밀도 있게 결합하여, 공간 속에 직접 갇힌 듯한 '벗어날 수 없는 공포감(NO EXIT)' 컨셉 브랜드 캠페인 제안 (5팀장/기획 총괄).",
    result: "애드파워 내 대형 브랜드 경쟁 PT 대상 수상. 단순한 스크린 스펙 소구가 아닌 철저한 타깃 리서치 기반 공간 마케팅으로 성공적인 인식 전환 설계 증명.",
    metrics: [
    ...
    role: "타깃 인식 분석 / 컨셉 도출 / 제안서 플로우 설계 / 발표 / 제작 디렉팅",
  ...
  },
  {
    ...
    subtitle: "기획자가 분석 기제와 매체가 되어보는 자발적 실험",
    challenge: "전략 수립 시 감과 직관에만 의존하는 기획에서 완벽 탈피하기 위해, 콘텐츠 업로드 시 실제 도달 지표와 유저 클릭 데이터를 숫자로 직접 검증하고 설득하는 능력이 필요했음.",
    action: "광고 속에 숨은 흥미로운 전략들을 해부하는 크리에이터 채널을 자발적으로 성장시키고, 프로필과 연동된 요약 소개 웹페이지의 스크롤 깊이 및 유저 저니(User Journey) 데이터를 추적함.",
    result: "첫 화면 이탈률 88% 도출 후, 히어로 마이크로 카피를 4차례에 걸쳐 수정한 결과 이탈률이 67%p 감소(21% 도달)했으며, 요일·시간 분석을 거쳐 금요일 23시 등 주 타깃 최적 활동 시간을 특정하여 도달 효과를 극대화함.",
    metrics: [
      { label: "채널 누적 팔로워", value: "2,000+ 명" },
      { label: "소개 페이지 이탈률", value: "88% ➡️ 21% (-67%p)", change: "4차 카피 개선 성과" },
      { label: "황금 시간대 도달률", value: "+41% 상승", change: "금요일 23시 입증" }
    ],
    period: "2026.03 ~ 2026.06",
    role: "광고 트렌드 리서치 / 콘텐츠 주제 기획 / GA4 기반 유입 분석 / 소개 페이지 카피 개선",
  ...
  },
  {
    ...
    subtitle: "브랜드가 말하지 않아도 반응하는 유저 중심 컨셉 기획",
    challenge: "브랜드의 장점만 일방적으로 나열하여 피로감과 거부감을 쉽게 느끼는 대학생 타깃을 극복하는 마케팅 전달법 강구.",
    insight: "대학생 타깃은 폰트 브랜드 자체보다, 본인들의 실질적인 일상 상황(과제 직전, PPT 제작 미션, 시험 마감 등)에 가장 빠르고 솔직하게 반응한다.",
    action: '"얘들아 선배가 폰트 이거 쓰랩" 타이틀로 대학생 선후배 밀착 상황극 숏폼 콘텐츠를 기획. 폰트 직접 마케팅을 후반부로 영리하게 연동하여 대학생 친화적 릴스 디렉팅 및 촬영/공동 편집 진행.',
    result: "대놓고 홍보하지 않는 브랜드 친화적 콘텐츠로 누적 조회수 2,000회 돌파 및 유의미한 팔로워 직접 전환을 유도하여 타깃 거부성 최소화 성공.",
    metrics: [
    ...
    role: "대학생 타깃 인사이트 도출 / 상황형 콘텐츠 컨셉 기획 / 릴스 대본 구성 / 촬영·편집 디렉팅",
