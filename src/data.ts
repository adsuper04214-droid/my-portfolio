...
export const projectsData: ProjectData[] = [
  {
    ...
    challenge: '"굳이 스크린X로?" 라는 {심리적 인식 장벽} 해결',
    insight: "기술이 아닌 {'몰입형 공간(Background)'} 경험으로 가치 재정의",
    action: "<에이리언: 로물루스> 타겟 맞춤형 {'벗어날 수 없는 공포감' 캠페인 제안} (기획 총괄)",
    aiUtilization: "ChatGPT를 활용해 커뮤니티 데이터 내 소비자 반응을 키워드 분석, 전략 수립의 논리적 근거로 활용하여 설득력을 높임.",
    result: "{평가단 만장일치 대상 수상}, 고부가가치 포지셔닝 전략 구축",
  ...
  },
  {
    ...
    challenge: "직관 중심 기획에서 {데이터 중심 기획}으로 전환",
    action: "유저 여정 추적 및 {AI 활용 카피 최적화}",
    aiUtilization: "Claude를 활용해 유저 이탈 구간의 데이터를 문장화하여, 가독성이 떨어지는 카피를 논리적으로 수정함.",
    result: "* 누적 팔로워 {1,200+} 확보\n이탈률 {88% → 67% (21%p 감소)}\n광고 도달 효율 {41% 증대}",
  ...
  },
  {
    ...
    challenge: "브랜드 일방적 홍보를 {대학생 타겟 공감형 콘텐츠}로 전환",
    insight: "브랜드 기능보다 '일상적 {상황}(과제/PPT)'에 반응하는 타겟 심리 포착",
    action: "브랜드의 폰트 기능을 일상의 '공감 상황'과 결합한 숏폼 콘텐츠 기획. 유저가 폰트의 필요성을 자발적으로 느끼게 하는 '상황형 마케팅' 전개.",
    aiUtilization: "ChatGPT를 활용해 대학생 커뮤니티 of '과제' 관련 페인 포인트를 분석하여, 공감대를 극대화할 수 있는 스토리라인 도출.",
    result: "{유저 자발적 2차 창작 유도} 및 광고 매체비 대비 높은 반응률 달성",
