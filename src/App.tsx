...
export const storyStages: StoryStage[] = [
  ...
  },
  {
    ...
    description: `대한민국 최고의 광고동아리 애드파워에서 대형 브랜드들과 마주하며 기획이 실전에서 어떻게 작동하는지 온몸으로 부딪쳤습니다. CJ ScreenX 경쟁 PT 당시, 팀 내에서는 ScreenX의 핵심 가치를 두고 '현장감'과 '기술력'이라는 의견 팽팽하게 맞서며 회의가 교착 상태에 빠졌습니다. 하지만 저는 답을 찾기보다 먼저 문제를 다시 들여다봤습니다. "사람들은 왜 ScreenX를 알고도 선택하지 않을까?" 저는 단순한 중재자에 머물지 않고 타깃이 영화를 소비하고 기억하는 본질적인 유저 저니를 다시 파고들었습니다. 관객은 영화를 기술이 아닌 '공간과 배경'으로 기억한다는 인사이트를 발견했고, "철저히 타깃의 언어로 말할 때 비로소 움직인다"는 기준 아래 전략의 방향을 재설계했습니다. 그 결과 영화 <에이리언: 로물루스>의 폐쇄 공포 공간을 활용한 'NO EXIT' 캠페인을 도출해 냈고, 결국 경쟁 PT 대상이라는 성과를 만들어냈습니다. 갈등의 순간마다 주관적인 감이 아닌 타깃의 행동과 인식을 기준으로 팀의 선택을 조율하는 짜릿함. 그것이 제가 광고에 미쳐있는 이유이자, 사람들이 움직이지 않는 이유를 끝까지 파고드는 AE로 성장하게 된 결정적인 경험이었습니다.`
  },
  {
    id: "execution-proven",
    stepNumber: "03",
    badge: "0→1,200 실행 증명",
    title: "0에서 1,200까지 직접 구르며 증명한, 실행형 AE",
    description: `이론으로만 배우는 기획은 죽은 기획이라 생각했기에 직접 필드로 나가 제 아이디어를 세상에 던졌습니다. 숫자로 설득하는 기획자가 되고자 자발적으로 광고 분석 채널을 개설했고, 콘텐츠 기획부터 제작, 데이터 분석까지 맨땅에 헤딩하며 팔로워 1,200명의 채널로 성장시켰습니다. 이 과정에서 GA4 분석을 접목해 첫 화면 스크롤 이전 단계에서 높은 이탈이 발생한다는 사실을 발견했습니다. 단순히 수치를 확인하는 데 그치지 않고 원인을 추적했습니다. 결국 히어로 카피를 네 차례 수정했고, 이탈률을 21%로 감소시키며 사람들의 행동 변화가 데이터로 증명되는 과정을 직접 경험했습니다.\n\n저는 아이디어만 던지고 뒷짐 지는 기획자가 아닙니다. 콘텐츠 제작의 현실을 알기에 제작팀과 원활하게 소통할 수 있고, 데이터를 볼 줄 알기에 클라이언트를 숫자로 설득할 수 있습니다. 무엇보다 사람들이 움직이지 않는 이유를 발견할 때까지 질문을 멈추지 않습니다. 남들이 결과를 볼 때 원인을 보고, 남들이 기능을 볼 때 사람을 보고, 남들이 답을 찾을 때 문제를 다시 정의합니다. 그것이 AE 김도현의 방식입니다. 기획의 무게를 아는 저의 열정으로, 소비자의 행동을 움직이는 전략을 만들겠습니다.`
  }
];
...
export const projectsData: ProjectData[] = [
  {
    ...
    insight: "관객은 영화를 단순한 '기술적 스펙'이 아닌, 극 중 몰입을 극대화하는 {'몰입형 공간(Background)'} 경험으로 경험할 때 높은 가치를 느낌.",
  ...
  },
  {
    ...
    aiUtilization: "Claude를 활용해 유저 이탈 구간의 데이터를 문장화하여, 가독성이 떨어지는 카피를 {AI 활용 카피 최적화}로 논리적 수정.",
    result: "누적 팔로워 {1,200+} 확보, 첫 화면 이탈률 {88% → 67% (21%p 감소)} 달성.",
    businessValue: "데이터 분석을 통한 '요일/시간별 최적 노출 시간(금요일 23시)' 도출 및 카피 수정으로 광고 효율 및 페이지 도달률 {41% 증대}.",
    metrics: [
      { label: "채널 누적 팔로워", value: "1,200+ 명" },
  ...
  },
  {
    ...
    businessValue: "기능 홍보가 아닌 유저 일상 속 맥락을 건드리는 콘텐츠 기획으로 광고 매체비 대비 {높은 반응률 달성}.",
    metrics: [
      { label: "인스타 조회수", value: "1,200+ 회" },
